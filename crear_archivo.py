...
def name_file():
    ...
    with open("./names_file.txt", "r", encoding="utf-8") as file:
        for line in file:
            # .rstrip('\n') sirve para eliminar saltos de linea 
            names.append(line.rstrip('\n'))
    # recorrer lista y generaar archivo 
    for line in  names:
        file =  open(line, "w", encoding="utf-8")
        file.write("# language: es\n@Cucumber\n  Escenario:\n    Dado El usuario ingresa a carga de trayectos\n    Cuando El usuario va a cargar un archivo de Excel\n    Entonces El archivo se carga al sistema\n") 
        # file.write("@Cucumber\n") 
